...
export const GITHUB_ICON = (title = '', width = 16, height = 16): JSX.Element =>
  <svg width={width} height={height} xmlns='http://www.w3.org/2000/svg' fill='currentColor' className='bi bi-github' viewBox='0 0 16 16'>
    <title>{title}</title>
